...
class Gait(object):
    ...
    def interpolate(self, solution, sw_curr, sw_tgt, clearance, sw_t, resol,
                    feet_ee_swing_trj=None, swing_default_dur=2.0):
        ...
        for i in range(swing_phase_num):
            ...
            if round(current_swing_duration, 2) == swing_default_dur:
                ...
                if i == 0:      # if it is the first swing phase
                    sw_interpl.append(feet_ee_swing_trj[i])
                    ...
                    sw_interpl.append(
                        interpol.swing_trj_triangle(sw_curr[i], sw_tgt[i], clearance, whole_future_swing_t, t_tot, resol))
