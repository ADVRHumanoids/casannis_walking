...
mon launch casannis_walking gait_payload.launch min_force:=220 target_dx:="[0.25, 0.25, 0.25, 0.25]" target_dz:="[0.3,0.3,0.0,0.0]" swing_id:="[3, 4]" clearance:=0.1 plots:=true swing_t1:="[1.0,3.0]" swing_t2:="[5.0,10.0]"
