...
mon launch casannis_walking gait_payload.launch min_force:=200 target_dx:="[0.25, 0.25, 0.25, 0.25]" target_dz:="[0.3,0.3,0.0,0.0]" swing_id:="[4]" clearance:=0.1 plots:=true swing_t1:="[2.0,6.0]"
