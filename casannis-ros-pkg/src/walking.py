...
class Walking:
    ...
    def interpolate(self, solution, sw_curr, sw_tgt, swing_t, resol):
        ...
        sw_cx = self.splines(swing_t, init_x, fin_x)
        sw_cy = self.splines(swing_t, init_y, fin_y)
        sw_cz = self.splines(swing_t, init_z, fin_z)
        ...
        sw_n1 = int(resol * (swing_t[0] - t_start))
        sw_n2 = int(resol * (t_end - swing_t[1]))
